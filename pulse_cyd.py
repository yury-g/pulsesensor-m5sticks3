# pulse_cyd.py — PulseSensor heart-rate monitor for the M5StickS3.
...
# NameError on a cold boot - `stick.sh run` hides it, because mpremote resumes
# into globals left over from the previous run. Always verify from main.py.
WIFI_W = 12
